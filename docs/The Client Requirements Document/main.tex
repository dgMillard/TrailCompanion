...
\begin{PstGanttChart}[unit=2,TaskOutsideLabelMaxSize=1, ChartShowIntervals]{22}{9} 
...
\PstGanttTask[TaskOutsideLabel={Tour Creation Usability},TaskUnitType=Day]{38}{25}
%------------------------ANDROID----------------------------------
